...
eval = false for this chunk too because of another problem. It says that it "could not find function 'accumulate2'" which doesn't make sense because the package that it's in (purr) is installed and loaded. The chunk runs just fine and produces a plot, it just won't render
